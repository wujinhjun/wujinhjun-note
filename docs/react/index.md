...
不过在正式深入探讨 React 与 Fiber 架构之前，我还是希望先写一篇第 0 篇。它不会深入源码细节，而是用来交代我为什么想写这系列文章、准备讨论哪些问题，以及在进入到 React 世界探险前，我们需要定好哪些概念坐标，以防走失。
...
* [第 0 篇：为什么我要写这一组 React 文章](./0-preface.md)
...
React 如何把一次更新，拆成一个可中断、可恢复、可排序，但最终又必须保持一致性的过程。
...
如果你已经会写 React 业务代码，但始终觉得自己对 React 内核的理解停留在概念层，那么这组文章应该会比较适合你。
